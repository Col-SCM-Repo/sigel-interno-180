...
Route::prefix('recursos-humanos')->middleware('auth')->group(function () {
    ...
    Route::get('/alumnos', ['uses' => 'ModuloRRHHController@alumnos', 'as' => 'rrhh.alumnos']);
    Route::post('/alumnos', ['uses' => 'ModuloRRHHController@getDataReloj'])->name('rrhh.alumnos.data');
    Route::post('/alumnos/descargar/{type?}', ['uses' => 'ModuloRRHHController@descargarPDF'])->name('rrhh.alumnos.download');
...
Route::prefix('carnets')->middleware('auth')->group(function () {
    #Dashboard
    Route::post('/obtener_carnets_anio', ['uses' => 'CarnetsController@ObtenerCarnetsPorAnio', 'as' => 'obtener.por.anio.carnets']);
    Route::get('/obtener_modelo', ['uses' => 'CarnetsController@ObtenerModelo', 'as' => 'obtener.modelo.carnets']);
    #guardar
...
Route::prefix('modulo_notas')->middleware('auth')->group(function () {
    Route::prefix('alumnos')->group(function () {
        Route::get('/', ['uses' => 'ModuloNotasController@AlumnoIndex', 'as' => 'index.alumno.modulo_notas']);
    });
    Route::prefix('notas')->group(function () {
