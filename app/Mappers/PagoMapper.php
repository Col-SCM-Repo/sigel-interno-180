<?php
    ...
    class PagoMapper
    {
        public function ModelToViewModel(Pago $_pago)
        {
            ...
            $_pagoVM->ruc =$_pago->ruc;
            $_pagoVM->razon_social =$_pago->MP_RAZON_SOCIAL;
            return $_pagoVM;
        }
        ...
        public function ViewModelToModel($_pagoVM)
        {
            ...
            $_pagoModel->RESPONSABLE_PAGO_ID = $_pagoVM->responsable_pago_id ;
            $_pagoModel->MP_RUC = $_pagoVM->ruc ;
            $_pagoModel->MP_RAZON_SOCIAL = $_pagoVM->razon_social ;
